...
val SpanishStrings = AppStrings(
    ...
    add = "Añadir",
    apiKeyConfiguration = "Configuración de API",
    apiKeyDescription = "Ingrese su clave de API de Gemini.",
    apiKeyLabel = "Clave de API",
    apiKeyPlaceholder = "AIza...",
    apiKeyHint = "Obtenga su clave de API de Google AI Studio",
    saveApiKey = "Guardar clave",
    apiKeySaved = "¡Clave guardada!",
    modelSettings = "Configuración del modelo",
    modelLabel = "Modelo",
    modelDescription = "Seleccione el modelo Gemini.",
    ...
    themeLight = "Claro",
    themeDark = "Oscuro",
    clipboardAutoAddLabel = "Añadir automáticamente",
    clipboardDetected = "URL detectada",
    clipboardMessage = "¿Añadir esta URL?",
    back = "Atrás",
    cancel = "Cancelar",
    save = "Guardar",
    ...
    tip = "💡 Consejo",
    quotaTipMessage = "El plan gratuito tiene límites.",
    addLinkDialogDescription = "El enlace se analizará.",
    urlLabel = "URL",
    ...
    notionPageNote = "Nota: información limitada.",
    backupAndRestore = "Copia de seguridad",
    backupDescription = "Hacer copia de seguridad.",
    createBackup = "Crear copia",
    restoreBackup = "Restaurar copia",
    backupSuccess = "¡Copia creada!",
    restoreSuccess = "¡Datos restaurados!",
    restoreFailed = "Error al restaurar",
    backupCreating = "Creando...",
    restoreInProgress = "Restaurando...",
    appVersion = "Versión",
    versionFormat = "Versión %s (Build %s)",
    reSummarize = "Re-analizar",
    analyzingTitle = "Analizando...",
    analyzingSummary = "IA analizando...",
    analysisFailedTitle = "Análisis fallido",
    analysisFailedSummary = "Error: %s"
)
